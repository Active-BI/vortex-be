...
<html>
  ...
  <body>
  <table align="center" width="300" height="300" cellpadding="0" cellspacing="0" style="border-collapse: collapse; background-color: #f598a3;">
  <tr>
    <td align="center" valign="middle" style="padding: 20px;">
      ...
      <p style="margin: 0;">
        <p style="display: inline-block; padding: 20px 20px; background-color: #ffffff; color: #f598a3; font-size: 16px; text-decoration: none; font-family: Arial, sans-serif;">${totp}</a>
      </p>
    </td>
  </tr>
</table>
...
<html>
  ...
  <tr>
    <td align="center" valign="middle" style="padding: 20px;">
      ...
      <p style="margin: 0;">
        <a href="${link}" style="display: inline-block; padding: 20px 20px; background-color: #ffffff; color: #f598a3; font-size: 16px; text-decoration: none; font-family: Arial, sans-serif;">Acesse Aqui</a>
      </p>
    </td>
  </tr>
</table>
